  ...
  function mount(msg, stack) {
    ...
    panel.outerHTML = html`
      <div id="__create_error_panel"
        ...
        <div
          class="bg-[#1F2937] text-[#FFFFFF] rounded-lg p-4 max-w-md
                 w-[calc(100vw-2rem)] mx-4 shadow-lg flex flex-col gap-2">
          <div class="flex items-start gap-3">
            <div class="flex-shrink-0">
              <div
                class="w-8 h-8 bg-[#FFFFFF] rounded-full flex
              ...
              <div class="flex gap-2">
                <button id="fix"
                  class="flex flex-row items-center justify-center gap-[4px]
                         ...
                         bg-[#F9FAFB] hover:bg-[#E5E7EB] active:bg-[#D1D5DB]
                         border-[#D1D5DB] text-[#111827] text-sm px-[8px] py-[4px] opacity-0">
                  Try to fix
                </button>
                ...
                <button id="logs"
                  class="flex flex-row items-center justify-center gap-[4px]
                         outline-none transition-all rounded-[8px] border-[1px]
                         bg-[#374151] hover:bg-[#4B5563] active:bg-[#6B7280]
                         border-[#4B5563] text-white text-sm px-[8px] py-[4px] opacity-0">
                  Show logs
                </button>

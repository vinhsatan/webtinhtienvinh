...
// Removed SessionProvider - using custom AuthContext instead
...
export function Layout({ children }: { children: ReactNode }) {
  ...
  // Ẩn cảnh báo defaultProps từ Recharts (thư viện bên thứ 3, không sửa được)
  useEffect(() => {
    const orig = console.error;
    console.error = (...args: unknown[]) => {
      if (typeof args[0] === 'string' && /defaultProps.*removed/.test(args[0])) return;
